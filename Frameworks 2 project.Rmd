...
```{r}
dat = AssistanceListings_DataGov_PUBLIC_CURRENT_20190706_AssistanceListings_DataGov_PUBLIC_CURRENT_20190706
```
...
mat = as.matrix(apply(dat,2,function(x)get_sentiment(x, method="syuzhet")))
